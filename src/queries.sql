...
(
    ...
    week integer,
    foreign key
(project_name) references Projects
(name),
    foreign key
...
values
    ('admin', 'admin', 'admin', 'admin@reportit.com');
...
VALUES
    ('abdo', 'abdo', '1234', 'abdo@pusb.se', 2);

insert into Users
    (username, name, password, email, role)
VALUES
    ('hadi', 'hadi', '1234', 'hadi@pusb.se', 2);
...
INSERT INTO Administrators
    (username, name, password, email)
VALUES
    ('admin2', 'admin2', 'admin2', 'admin2@pusb.se');
...
INSERT INTO Users
    (username, name, password, email, role, project)
VALUES
    ('daniel', 'daniel', '1234', 'daniel@pusb.se', 2, 'databas');

INSERT INTO Users
    (username, name, password, email, role, project)
VALUES
    ('nils', 'nils', '1234', 'nils@pusb.se', 2, 'java');
